#!/usr/bin/env python3
"""Apply retrospective long-option execution realism to an experiment JSON.

This command reads only a local historical experiment and local research store.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--fill-at-trigger-ask",
        action="store_true",
        help="Less-conservative evaluation mode: fill at displayed trigger ask instead of submitted limit",
    )
